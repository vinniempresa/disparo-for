...
class For4PaymentsAPI:
    ...
    def create_pix_payment(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Se o CPF for o de teste padrão (123.456.789-00), use um CPF válido
            if cpf == "12345678900":
                cpf = "11144477735"  # CPF válido para teste
                current_app.logger.info(f"CPF de teste detectado, usando CPF válido: {cpf[:3]}...{cpf[-2:]}")
...
def create_payment_api(secret_key: Optional[str] = None) -> For4PaymentsAPI:
    ...
    if secret_key is None:
        ...
        # Se a chave ainda for a URL antiga, use a nova chave
