...
def generate_pix():
    try:
        ...
        secret_key = "048a81ec-560b-4e3e-bb97-abd49cb02a46"  # Use a chave fornecida diretamente
        ...
        # Log dos dados reais do cliente
        app.logger.info(f"[PROD] Dados do cliente da sessão: {customer_data}")
        ...
        payment_data = {
            ...
            'amount': 118.68  # Valor fixo da dívida
        }
